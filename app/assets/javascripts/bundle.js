...
/***/ function(module, exports, __webpack_require__) {
	...
	window.KeyListener = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ToneMap = __webpack_require__(160);
	var Key = __webpack_require__(161);
	...
	var Organ = React.createClass({
	  ...
	  renderKeys: function () {
	    ...
	    return keysArray.map(function (key, idx) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'p',
	            { className: 'show-link', onClick: this.toggleNoteNames },
	            this.state.showNotesText
	          ),
	          React.createElement(
	            'p',
	            { className: 'show-link', onClick: this.toggleKeyNames },
	            this.state.showKeysText
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToneMap = __webpack_require__(160);
	var KeyNameMap = __webpack_require__(186);
	...
	var Recorder = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        { onClick: this.recordClick, className: "button record-button" + recordingStatus },
	        "\u25CF"
	      ),
	      React.createElement(
	        'p',
	        { onClick: this.playClick, className: 'button play-button' },
	        "▶"
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Track.prototype = {
	  ...
	  play: function () {
	    if (this.interval) {
	      return;
	    } // don't play if already in progress
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyAction = __webpack_require__(184);
